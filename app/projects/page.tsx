...
export const metadata = pageMeta(
  ...
  'แนวคิดการออกแบบการนำลิฟต์บ้าน ลิฟต์โดยสาร และประตูลิฟต์มาใช้กับบ้านพักอาศัย คอนโดมิเนียม อาคารสำนักงาน และโรงแรม (เป็นแนวคิดการออกแบบ ไม่ใช่ผลงานที่ส่งมอบแล้ว)',
  '/projects',
);
