...
**2026-09-23 cleanup.** `public/images/hero-theme-generated.png` (2.0 MB) and
`public/images/hero-theme.jpg` (310 KB) were deleted at the client's request. Both had been
untracked leftovers from an earlier session with no reference anywhere in `app/`, `components/`,
